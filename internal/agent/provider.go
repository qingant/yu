...
func NewProvider(model, apiKey, baseURL string, maxTokens int, reasoningEffort string) Provider {
	return NewProviderWithProtocol("", model, apiKey, baseURL, maxTokens, reasoningEffort)
}
...
func NewProviderWithProtocol(protocol, model, apiKey, baseURL string, maxTokens int, reasoningEffort string) Provider {
